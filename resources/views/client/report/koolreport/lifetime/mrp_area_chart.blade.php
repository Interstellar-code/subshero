        ...
        <div>
            <script>
                $(document).ready(function() {
                    app.report.o.lifetime.mrp_area_chart = JSON.parse('@json(lib()->cache->report_lifetime_mrp_area_chart)');
                });
            </script>
            ...
            Area::create([
                // 'title' => 'Sale vs Cost',
                'dataSource' => lib()->cache->report_lifetime_mrp_area_chart,
                'columns' => [
                ...
                'options' => [
                    'hoverCallback' => 'function(index, options, content, row) { return app.report.f.lifetime.mrp_area_chart.tooltip_label(index, options, content, row); }',
                ],
            ]);
            ?>
        </div>
