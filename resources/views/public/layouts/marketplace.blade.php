        ...
        <div class="app-header header-shadow">
            <div class="container fiori-container justify-content-between">
                ...
                <div class="app-header__logo">
                    ...
                    @empty($_SESSION['marketplace']->marketplace_token)
                        <a href="{{ url('/') }}" class="logo-src"></a>
                    @else
                        <a href="{{ route('app/marketplace/showcase', $_SESSION['marketplace']->marketplace_token) }}" class="logo-src"></a>
                    @endempty
                </div>
                    ...
                    <div class="widget-content p-0">
                        <div class="widget-content-wrapper">
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a href="{{ route('app/marketplace/checkout/show') }}" class="p-0 btn">
                                        <i class="fa fa-shopping-cart fa-lg mr-1"></i>
                                        <strong>@lang('Cart')</strong>
                                    </a>
                                </div>
                            </div>
                        </div>
