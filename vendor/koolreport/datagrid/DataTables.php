...
class DataTables extends Widget
{
    ...
    protected function onInit()
    {
        ...
        $this->clientEvents = Util::get($params, "clientEvents", false);
        ...
        $this->complexHeaders = Util::get($params, "complexHeaders", false);
        $this->headerSeparator = Util::get($params, "headerSeparator", '-');
        $this->searchOnEnter = Util::get($params, "searchOnEnter", false);
        $this->searchMode = strtolower(Util::get($params, "searchMode", "default"));
